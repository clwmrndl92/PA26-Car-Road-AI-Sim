...
const CarPersonality &GetCarPersonality(CarPersonalityType type)
{
        ...
        static const CarPersonality personalities[] = {
            CarPersonality{1.0f, 1.0f, 4.0f, 15.0f, 1.0f, 0.2f}, // Normal
            CarPersonality{1.2f, 0.8f, 6.0f, 20.0f, 1.2f, 0.3f}, // Aggressive
            CarPersonality{0.8f, 1.2f, 3.0f, 10.0f, 0.8f, 0.1f}, // Cautious
        };
