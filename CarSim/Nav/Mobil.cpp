...
namespace Mobil
{
    ...
    namespace
    {
        float Accel(const VehicleState &ego, const VehicleState &leader, const IDM::Params &cfParams)
        {
            return IDM::CalculateAcceleration(ego.speed, ego.accel, leader.speed, leader.accel,
