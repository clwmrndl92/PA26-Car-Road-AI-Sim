    ...
    _In_opt_ const WCHAR* strMsg, _In_ bool bPopMsgBox)
{
    ...
    // Since Windows SDK 8.0, DirectX error messages are integrated into the error codes and can be
    // retrieved as strings via FormatMessageW without allocating string memory
    ...
    if (errorStr)
    {
        errorStr[0] = L'\0';	// Erase the newline appended by FormatMessageW (replace the \r in \r\n with \0)
    }
